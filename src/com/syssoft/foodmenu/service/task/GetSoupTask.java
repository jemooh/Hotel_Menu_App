...
import com.syssoft.foodmenu.util.StreamUtils;
		...
		public class GetSoupTask extends  Activity implements Runnable {
		    ...
		    private String Url;
		    private static String MainURL = "http://10.0.2.2/soup_data.php";
		     ...
		     */
		    public GetSoupTask(Handler replyTo,  String email, String userPassword) {
			...
			public void run() {
				...
				try {
		         ...
		         HttpClient client = new DefaultHttpClient();
		            ...
		            //String jsonString = getResources().getString(R.string.JSonSoup);
