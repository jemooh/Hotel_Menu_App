...
import com.syssoft.foodmenu.util.StreamUtils;
		...
		public class GetSavedColdDrinksTask extends  Activity implements Runnable {
		     ...
		     */
		    public GetSavedColdDrinksTask(Handler replyTo,  String email, String userPassword) {
		        this.replyTo = replyTo;
		        this.email = email;
		            this.jsonString = ListDrinksFragment.jsonString;
