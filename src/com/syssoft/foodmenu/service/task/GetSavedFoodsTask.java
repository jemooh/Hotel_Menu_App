...
import com.syssoft.foodmenu.util.StreamUtils;
		...
		public class GetSavedFoodsTask extends  Activity implements Runnable {
		     ...
		     */
		    public GetSavedFoodsTask(Handler replyTo,  String email, String userPassword) {
		        this.replyTo = replyTo;
		        this.email = email;
		            this.jsonString = ListMainCoursesFragment.jsonString;
