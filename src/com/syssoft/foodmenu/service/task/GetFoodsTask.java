...
import com.syssoft.foodmenu.util.StreamUtils;
		...
		public class GetFoodsTask extends  Activity implements Runnable {
		    ...
		    private String Url;
		    private static String MainURL = "http://10.0.2.2/food_data.php";
		     ...
		     */
		    public GetFoodsTask(Handler replyTo,  String email, String userPassword) {
			...
			public void run() {
				...
				try {
		            ...
		            //String jsonString = getResources().getString(R.string.JSonMain);
