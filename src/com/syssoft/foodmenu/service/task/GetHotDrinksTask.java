...
import com.syssoft.foodmenu.util.StreamUtils;
		...
		public class GetHotDrinksTask extends  Activity implements Runnable {
		    ...
		    private String Url;
		    private static String MainURL = "http://10.0.2.2/Hot_Drinks_data.php";
		     ...
		     */
		    public GetHotDrinksTask(Handler replyTo,  String email, String userPassword) {
			...
			public void run() {
				...
				try {
		            ...
		            //String jsonString = getResources().getString(R.string.JSonHot);
