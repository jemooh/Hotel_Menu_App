...
import com.syssoft.foodmenu.util.StreamUtils;
		...
		public class GetSavedHotDrinksTask extends  Activity implements Runnable {
		     ...
		     */
		    public GetSavedHotDrinksTask(Handler replyTo,  String email, String userPassword) {
		        this.replyTo = replyTo;
		        this.email = email;
		            this.jsonString = ListHotDrinksFragment.jsonString;
