...
import com.syssoft.foodmenu.util.StreamUtils;
		...
		public class GetSavedSoupTask extends  Activity implements Runnable {
		     ...
		     */
		    public GetSavedSoupTask(Handler replyTo,  String email, String userPassword) {
		        this.replyTo = replyTo;
		        this.email = email;
		            this.jsonString = ListSoupFragment.jsonString;
