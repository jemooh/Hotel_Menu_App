...
import com.syssoft.foodmenu.src.MainActivity;
	...
	public class HotelOrderDialogFragment extends DialogFragment {
		...
		public static HotelOrderDialogFragment newInstance(int id){
			
			HotelOrderDialogFragment dialogFragment = new HotelOrderDialogFragment();
		...
		public Dialog onCreateDialog(Bundle savedInstanceState) {	
			...
			switch (id) {
				case FEEDBACK_DIALOG:
			 		...
			 		dialogview = inflater.inflate(R.layout.hotel_order, null);
		 
			 		dialogbuilder = new AlertDialog.Builder(getActivity());
			 		dialogbuilder.setTitle("HOTEL ORDER!");
		...
		int id =getArguments().getInt("id");
		  	switch (id) {
		  		case FEEDBACK_DIALOG:
		  			...
		  			final EditText txttableno = (EditText) alertDialog.findViewById(R.id.txttableno);
		  			...
		  			btn_submit.setOnClickListener(new View.OnClickListener() {
		  				...
		  				public void onClick(View v) {
		  					String tableno = txttableno.getText().toString();
		  					alertDialog.dismiss();
		  					db.addHotelorder(tableno);
